...
using BestGirl.Core.Discord.Gateway;
using BestGirl.Core.Discord.Rest;

namespace BestGirl.Core.Client
{
	public partial class BestGirlClient
	{
		...
		public async Task Connect()
		{
			...
			BotUser = AddOrGetUser(RestClient.GetCurrentUserAsync().Result);
		...
		public void UseService<TService>() where TService : IService, new()
		{
